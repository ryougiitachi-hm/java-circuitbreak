...
@Slf4j
public class SetUserRedisHystrixCommand extends HystrixCommand<String> {

    private RedisPort redisPort;

    private String username;

    public SetUserRedisHystrixCommand(RedisPort redisPort, String username) {
        super(Setter.withGroupKey(HystrixCommandGroupKey.Factory.asKey("redisPort"))
                .andCommandKey(HystrixCommandKey.Factory.asKey("updateUserInfo"))
    ...
    protected String run() throws Exception {
        redisPort.updateUserInfo(this.username);
        return "OK";
    }
